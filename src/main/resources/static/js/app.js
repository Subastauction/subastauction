var controlador = (function () {
    ...
    var verEventos = function (json) {
        ...
        for (var i in json) {
            ...
            var s = "<div class='col-lg-3 col-md-6 mb-4 mb-lg-0' style='background: #2fd3f0ea;' >" +
                ...
                "<input onclick=\"window.location='./evento.html?value=" + id + "';\"  type='button' value='ingresar' style='style='margin-left: auto; margin-right: auto;'>" +
                "</div>" +
                "</div>" +
                "</div>";
